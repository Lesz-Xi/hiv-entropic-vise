...
\textbf{Incomplete Viral Suppression.} Reducing viral load to ``undetectable'' levels ($<$50 copies/mL) leaves $10^6$--$10^7$ latently infected cells that persist for decades \citep{Hosmane2017}. The detection threshold is a measurement limit, not a biological reality.
...
\textbf{Innovation 3: Active Detection.} Traditional latency measurement is passive (QVOA requires 2--3 weeks, underestimates reservoir by 60-fold) \citep{Ho2013, Siliciano2022}. Our Sentinel Cell approach provides real-time detection of viral reactivation.
